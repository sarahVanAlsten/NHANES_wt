...
svy, subpop(if raceNew == 1): mlogit doingAbtWt i.fsAny i.ageNew i.BMIcat i.Male i.edu, rrr baseoutcome(5)

svy, subpop(if Race == 0): mlogit doingAbtWt i.fsAny i.ageNew i.edu i.BMIcat i.Male i.depressionBinary, rrr baseoutcome(5)
svy, subpop(if raceNew == 1): mlogit doingAbtWt i.fsAny i.ageNew i.BMIcat i.Male i.edu i.depressionBinary, rrr baseoutcome(5)
...
//model 2
svy, subpop(if obese == 1): mlogit doingAbtWt i.fsAny i.ageNew i.eduNew i.Race i.Male, rrr baseoutcome(5)

//also adjust for bmicat (degree of obesity here)
svy, subpop(if obese == 1): mlogit doingAbtWt i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat, rrr baseoutcome(5)

//and depression
svy, subpop(if obese == 1): mlogit doingAbtWt i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat i.depressionBinary, rrr baseoutcome(5)

//look for interactions
svy, subpop(if obese == 1): mlogit doingAbtWt i.fsAny##i.Race i.ageNew i.eduNew i.Male i.BMIcat i.depressionBinary, rrr baseoutcome(5)
mlogtest, wald
svy, subpop(if obese == 1): mlogit doingAbtWt i.fsAny##i.Male i.ageNew i.eduNew i.Race i.BMIcat i.depressionBinary, rrr baseoutcome(5)
svy, subpop(if obese == 1): mlogit doingAbtWt i.fsAny##i.Race##i.Male i.ageNew i.eduNew i.BMIcat i.depressionBinary, rrr baseoutcome(5)
...
//model 2
svy, subpop(if obese == 1): mlogit LikeToWeigh i.fsAny i.ageNew i.eduNew i.Race i.Male, rrr baseoutcome(0)

//also adjust for bmicat (degree of obesity here)
svy, subpop(if obese == 1): mlogit LikeToWeigh i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat, rrr baseoutcome(0)

//and depression
svy, subpop(if obese == 1): mlogit LikeToWeigh i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat i.depressionBinary, rrr baseoutcome(0)
...
//model 2
svy, subpop(if obese == 1): mlogit ConsiderWt i.fsAny i.ageNew i.eduNew i.Race i.Male, rrr baseoutcome(0)

//also adjust for bmicat (degree of obesity here)
svy, subpop(if obese == 1): mlogit ConsiderWt i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat, rrr baseoutcome(0)

//and depression
svy, subpop(if obese == 1): mlogit ConsiderWt i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat i.depressionBinary, rrr baseoutcome(0)
...
//model 2
svy, subpop(if BMIcat >2): mlogit doingAbtWt i.fsAny i.ageNew i.eduNew i.Race i.Male, rrr baseoutcome(5)

//also adjust for bmicat (degree of obesity here)
svy, subpop(if BMIcat>2): mlogit doingAbtWt i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat, rrr baseoutcome(5)

//and depression
svy, subpop(if BMIcat>2): mlogit doingAbtWt i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat i.depressionBinary, rrr baseoutcome(5)
...
//model 2
svy, subpop(if BMIcat >2): mlogit LikeToWeigh i.fsAny i.ageNew i.eduNew i.Race i.Male, rrr baseoutcome(0)

//also adjust for bmicat (degree of obesity here)
svy, subpop(if BMIcat >2): mlogit LikeToWeigh i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat, rrr baseoutcome(0)

//and depression
svy, subpop(if BMIcat >2): mlogit LikeToWeigh i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat i.depressionBinary, rrr baseoutcome(0)

//look for interactions
svy, subpop(if BMIcat >2): mlogit LikeToWeigh i.fsAny##i.Race i.ageNew i.eduNew i.Male i.BMIcat i.depressionBinary, rrr baseoutcome(0)
svy, subpop(if BMIcat >2): mlogit LikeToWeigh i.fsAny##i.Male i.ageNew i.eduNew i.Race i.BMIcat i.depressionBinary, rrr baseoutcome(0)
svy, subpop(if BMIcat >2): mlogit LikeToWeigh i.fsAny##i.Race##i.Male i.ageNew i.eduNew i.BMIcat i.depressionBinary, rrr baseoutcome(0)
...
//model 2
svy, subpop(if BMIcat >2): mlogit ConsiderWt i.fsAny i.ageNew i.eduNew i.Race i.Male, rrr baseoutcome(0)

//also adjust for bmicat (degree of obesity here)
svy, subpop(if BMIcat >2): mlogit ConsiderWt i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat, rrr baseoutcome(0)

//and depression
svy, subpop(if BMIcat >2): mlogit ConsiderWt i.fsAny i.ageNew i.eduNew i.Race i.Male i.BMIcat i.depressionBinary, rrr baseoutcome(0)

//look for interactions
svy, subpop(if BMIcat >2): mlogit ConsiderWt i.fsAny##i.Race i.ageNew i.eduNew i.Male i.BMIcat i.depressionBinary, rrr baseoutcome(0)
svy, subpop(if BMIcat >2): mlogit ConsiderWt i.fsAny##i.Male i.ageNew i.eduNew i.Race i.BMIcat i.depressionBinary, rrr baseoutcome(0)
svy, subpop(if BMIcat >2): mlogit ConsiderWt i.fsAny##i.Race##i.Male i.ageNew i.eduNew i.BMIcat i.depressionBinary, rrr baseoutcome(0)
/////////////////////////////////////////////////////////////////////
//amon 'normal' weight
//unadj
svy, subpop(if BMIcat ==2): mlogit doingAbtWt i.fsAny, rrr baseoutcome(5)
