...
whq <- plyr::rbind.fill(whq09, whq11, whq13, whq07)
...
fsq <- plyr::rbind.fill(fsq09, fsq11, fsq13,fsq07)
...
#put all the data into one frame
dbq <- plyr::rbind.fill(dbq09, dbq11, dbq13, dbq07)
...
#put all the data into one frame
duq <- plyr::rbind.fill(duq09, duq11, duq13, duq07)
...
#put all the data into one frame
dpq <- plyr::rbind.fill(dpq09, dpq11, dpq13, dpq07)
...
#put all the data into one frame
smq <- plyr::rbind.fill(smq09, smq11, smq13, smq07)
...
#put all the data into one frame
alq <- plyr::rbind.fill(alq09, alq11, alq13, alq07)
...
#put all the data into one frame
acq <- plyr::rbind.fill(acq09, acq11, acq13, acq07)
...
#put all the data into one frame
bmx <- plyr::rbind.fill(bmx09, bmx11, bmx13, bmx07)
